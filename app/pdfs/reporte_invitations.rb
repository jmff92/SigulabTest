...
class ReporteInvitations < Prawn::Document
 ...
 def tittle 
  ...
  def texto
    ...
    move_down 10
    text"Para dar cumplimiento con lo establecido en el articulo 73 con Rango, Valor y Fuerza de Ley de Contrataciones Públicas (Gaceta Nº 39.503 de Fecha 06 de septiembre 2010), referente al Procedimiento por <u><b>Consulta de Precios</b></u> hasta 2.500 U.T. para bienes, ó 5.000 U.T. para servicios, en concordancia con los artículos 109 y 113 del Reglamento de Ley de Contrataciones Públicas (Gaceta oficial 39.181 de fecha 19 de Mayo 2009), tenemos el agrado de dirigirnos a ustedes, en la oportunidad de solicitar una oferta, la cual debe contener la siguiente información:", :align => :justify, :indent_paragraphs => 40, :inline_format => true, :size => 11

#445

    text_box "• Especificaciones Técnicas", :at => [0, 400], :size => 11
    text_box "• Monto de la Oferta", :at => [0, 385], :size => 11
    text_box "• Modalidad de pago", :at => [0, 370], :size => 11
    text_box "• Garantía", :at => [0, 355], :size => 11
	  text_box "• Tiempo de entrega",:at => [160, 400], :size => 11
    text_box "• Validez de la oferta", :at => [160, 385], :size => 11
    text_box "• Domicilio Principal ",:at => [160, 370], :size => 11
    text_box " (Dirección de la Empresa)",:at => [168,355], :size => 11
    text_box "• Constancia de Inscripción en el Registro" , :at => [317, 400], :size => 11
    text_box "  de Proveedores Interno USB.", :at => [323,385], :size => 11
    text_box "• Valor Agregado Nacional (Art. 9 de " ,:at => [317, 370], :size => 11
    text_box "la Ley de Contrataciones Públicas).", :at => [323,355], :size => 11
    stroke do
   ...
   move_down 5
   text " Atentamente,", :align => :center, :size => 11
   ...
   move_down 25
   text "#{@invitation.responsable}", :align => :center, :size => 11
   draw_text "Recibido por", :at => [425,60], :size => 11
